...
class ExampleApp(QtWidgets.QMainWindow, config.Ui_MainWindow):
    def __init__(self):
        #   Это здесь нужно для доступа к переменным, методам
        #   и т.д. в файле config.py
        super().__init__()
    ...
    def load_data_from_file(self):
        from data_functions import create_data_arrays_from_file, load_file, read_cell_range
